...
func TestLegacyEpisodeBases(t *testing.T) {
	...
	cases := []struct {
		...
		{"renamed since, a folder named like an nfo", legacyRow(1, "Even Flow (2024)", 5, season, "Show - s01e05 - Even Flow [Drumless].mp4"), season,
			map[string]bool{"Show - s01e05 - Even Flow.nfo": true},
			[]string{"Show - s01e05 - Even Flow [Drumless]", "Show - s01e05 - Even Flow", "Show - s01e05 - Even Flow (2024)"}, false},
